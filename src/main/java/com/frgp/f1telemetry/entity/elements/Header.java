...
public class Header {
    ...
    private long gameMajorVersion;
    private long gameMinorVersion;
    ...
    public long getGameMajorVersion() {
        return gameMajorVersion;
    }

    public void setGameMajorVersion(long gameMajorVersion) {
        this.gameMajorVersion = gameMajorVersion;
    }

    public long getGameMinorVersion() {
        return gameMinorVersion;
    }

    public void setGameMinorVersion(long gameMinorVersion) {
